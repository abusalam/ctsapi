...
{
    public class StampRequisitionApproveRepository : Repository<VendorRequisitionApprove, CTSDBContext>, IStampRequisitionApproveRepository
    {
        protected readonly CTSDBContext _context;
        public StampRequisitionApproveRepository(CTSDBContext context) : base(context)
        {
            _context = context;
